...
class coconuts:
    ...
    def __is_carrying_possible(self, ounces_of_birds, pounds_of_coconuts):
    ...
    def main(self):
        ounces_of_birds = self.__getValue(1)
        pounds_of_coconuts = self.__getValue(2)
        print(self.__is_carrying_possible(ounces_of_birds, pounds_of_coconuts))
